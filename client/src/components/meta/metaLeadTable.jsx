export default function MetaLeadTable({ leads, setSelectedLead, setShowAssignModal }) {
  ...
  return (
    <div className="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden">
      ...
      {/* Table Header */}
      <div className="px-6 py-5 flex justify-around items-center border-b border-gray-200">
